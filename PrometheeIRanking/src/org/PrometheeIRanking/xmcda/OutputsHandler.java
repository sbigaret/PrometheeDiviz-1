...
public class OutputsHandler {
     ...
     */
    public static Map<String, XMCDA> convert(List<String> alternatives, Map<Pair<String, String>, String> alternativesComparison, ProgramExecutionResult executionResult)
    {
