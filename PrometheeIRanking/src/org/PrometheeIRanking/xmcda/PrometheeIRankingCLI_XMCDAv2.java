...
public class PrometheeIRankingCLI_XMCDAv2 {
    ...
    public static void main(String[] args) throws Utils.InvalidCommandLineException, ValueConverters.ConversionException {
        ...
        Utils.loadXMCDAv2(xmcda_v2, new File(indir, "alternatives.xml"), false,
                executionResult, "alternatives");
        Utils.loadXMCDAv2(xmcda_v2, new File(indir, "positive_flow.xml"), false,
                executionResult, "alternativesValues");
        Utils.loadXMCDAv2(xmcda_v2, new File(indir, "negative_flow.xml"), false,
                executionResult, "alternativesValues");
