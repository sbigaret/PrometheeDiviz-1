...
public class NetFlowScoreIterativeCLI {
    public static void main(String[] args) throws Exception
    {
        final ArrayList<String> argsList = new ArrayList<String>(Arrays.asList(args));
        if ( argsList.remove("--v2") )
        {
            NetFlowScoreIterativeCLI_XMCDAv2.main((String[]) argsList.toArray(new String[]{}));
        }
        else if ( argsList.remove("--v3") )
        {
            NetFlowScoreIterativeCLI_XMCDAv3.main((String[]) argsList.toArray(new String[]{}));
        }
        else
        {
