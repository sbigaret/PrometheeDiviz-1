...
import org.NetFlowScoreIterative.NetFlowScoreIterative;
...
public class NetFlowScoreIterativeCLI_XMCDAv3 {
    /**
     * @param args
     */
    public static void main(String[] args) throws Utils.InvalidCommandLineException, ValueConverters.ConversionException, ClassNotFoundException {
        ...
        try
        {
            results = NetFlowScoreIterative.calculateNetFlowScoreIterative(inputs, executionResult);
        }
        catch (Throwable t)
        {
